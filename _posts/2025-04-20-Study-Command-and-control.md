...
- 需要在很短时间内做出决策；
- 信息是片面的、不完整的、甚至可能是误导的；
- 由于主客观原因，无法对信息进行深入分析和判断；
- 确保行动成功的决策标准模糊不清。

指挥决策思维：

- 依赖自己的军事素养、作战经验、直觉判断等快速找到一个可行方案；
- 自觉地或下意识地运用各种有效地决策思维，个人的感觉和知觉在指挥决策过程中起着巨大的作用。

## 2 决策偏见与错误

- 选择性知觉偏见：决策者根据他们有偏见的认知，有选择地感知和理解事物；
- 确认性偏见：决策者确立了某一个信念和观念后，在收集信息和分析信息的过程中，产生的一种寻找支持这个信念证据的倾向。
- 可获得性偏见：人们进行预测和决策时，大多利用自己熟悉的、或能够凭想象构造而得到的信息，导致赋予那些意见的、容易激起的信息以较大权重。
- 过度自信偏见：决策者倾向于高估自己能力和表现，或者高估自己对某一情况认识程度。是最普遍，也是最灾难性的偏见。
- 即时满足偏见：决策者追求即时的回报，避免即时的损失。
- 随机性偏见：决策者试图从随机事件中创造意义。
- 自利偏见：人们倾向于从好的方面看待自己，成功时归因于自己的能力或努力，而失败时则倾向于归咎于外部因素或运气不佳。
- 事后之明偏见：决策者在已经知道结果后，错误地认为他们本可以正确预测到结果。

## 3 如何更好地决策

- 关注自己的决策过程，反省自己常用的经验法则，批判性评估这些方法的合理性，停下来检查自己有没有陷入决策偏见；

- 让其他人提醒自己决策中的弱点，借鉴局外人的观点
...
指挥员及其指挥机关对编成内单元及其他力量进行组织、协调、掌握、制约的活动，确保行动同步有序，保证行动目标、行动计划的完成，确保行动意图得以贯彻和实现。

> 思考：所以说，指挥控制，就是指挥决策和行动控制（？）。

行动控制是指挥员把决策付诸实践的过程。

主要可分为以下4类：

1. 目标的控制：目标体现着行动所要达到的预定目的和企图，行动的基本走向和预期最终状态必须与之基本吻合。指挥员通过确定或调整目标，实现对行动的整体性、全局性控制；
2. 时机的控制：对时间、空间因素的充分把握与合理利用，在最适合的时间促使行动对象进入或者退出行动场所、开展指定的行动。指挥员需要在正确理解和领会上级企图，正确认识和掌握客观条件的基础上，选择有利时机调控行动对象。
3. 进程的控制：需要控制行动的节奏和速度，驱动行动要素和单元按计划完成特定任务。对进程的控制主要基于计划，环境及其他偶然因素造成的计划执行偏差，并确定纠正行动偏差量的标准。
4. 协同关系的控制：行动的成败，很大程度上取决于各力量行动配合的质量。指挥员及其指挥机关需要及时调整控制各行动单位间的协同关系。

### 1.2 控制与协调的异同点

控制：主要针对目标的达成，强调对指挥对象采取纠正措施、使其符合期望，

协调：则关注内部视角，强调对所属各力量、平台在时间、空间、任务等方面的相互关系进行调整，确保有序，协调一致地行动，发挥好整体效益，形成合力。

控制与协调必须连续不断地贯穿于行动全过程，这样才能达成行动控制的目的

### 1.3 协调与协同的异同点

在行动控制中，两者的共同点在于均强调多方配合，合力完成任务。

不同之处在于，“协调”突出手段，即通过调整多方之间的关系使其实现同步这往往是上级指挥员或指挥机构的职能；

“协同”则突出效果，即形成团队合力，既可以通过上级的协调实现，也可以自主实现。

因此，不依赖于集中控制的自主协同与基于任务的自主式控制方式密切相关，

## 2 控制方式

除了基于政策和规则的方式外，还有2类基本控制方式，为
...
通过将系统状态与计划进行比较，识别偏差并进行及时调整；是集中式的控制，关注实现目标过程中的每一具体步骤和环节。

> [!tip]
>
> **例子**：美军在伊拉克战场的反伏击作战

强调对指挥对象行为过程的控制和掌握，通过将其所处的状态与计划中的预期状态或任务目标相对比找出偏差，并针对性的下达调控指令，对控制对象行动偏差进行纠正或调整。

![基于计划的反馈式控制](./../images/img-2025-04-20/基于计划的反馈式控制.png)

流程为：

1. 规定行动的标准：指挥员和指挥机关下达的任务、行动方法和行动标准，这是行动的依据，又是控制行动的标准。
2. 检查行动效果：指挥员运用各种手段，掌握系统运行状态，得衡量行动效果。
3. 反馈比较：指挥员通过将行动效果与行动标准进行比较，找出偏差问题及其原因。
4. 采取纠正偏差的措施：寻找解决问题的方案，使系统沿着目标轨道运行。

## 2.1 基于任务的自主式控制

强调下级在准确理解上级意图下，根据当前情况和可用资源自我纠偏、自行同步；是分散式的控制，注重于最终的结果状态。

> [!tip]
>
> **例子**：解放战争中辽沈战役的胡家窝棚战斗，以及现代战争中无人蜂群作战等

强调下级指挥员在准确理解上级意图下，根据当前情况和可用资源，自我纠偏、自行同步，是充分发挥一线自主性应对非预料情况的一种控制方式。

![基于任务的反馈式控制](./../images/img-2025-04-20/基于任务的自主式控制.png)

上级指挥员及上级指挥机关的作用有2个，为

1. 明确任务/目标；
2. 为下级提供所需的资源，支持和保障下属部队的有效行动。
...
> [!tip]
>
> **例子1**：通用电气的CE0韦尔奇在回忆录《赢》的案例:
>
> - 通用电气原本在核磁共振市场中产品领先，但通用的产品孔径太小，给人以压抑感.
> - 竞争对手开始开发大孔径的核磁共振设备，但公司内部的开发人员认为，孔径加大会导致成像准确度下降，医院不会接受。
> - 韦尔奇一有机会就督促医疗部门的人考虑有没有可能改进成像技术，但他得到的反应都是敷衍，也即韦尔奇的前馈管理是失败的。
> - 最终通用失去了核磁共振设备的产品领先地位

> [!tip]
>
> **例子2**：“管理之父”亨利·法约尔的试验
>
> 挑选20个技术相近的工人，每10人一组，在相同条件让两组同时进行生产。每隔一小时，他会检查一下工人们的生产情况。
>
> - 第一组：记录下他们各自生产的数量，但不告诉工人他们工作的进度。
> - 第二组：每个员工了解他们的工作进度。每次考核完毕，法约尔会在生产速度最快的两个工人的机器上插上红旗；速度居中的四个工人插上绿旗；最后的四个工人插上黄旗。如此一来，每个工人对自己的进度一目了然。
>
> 试验结果：第二组工人的生产效率远远高于第一组。

### 1.2 启示

- 行动控制领导者必须参与到细节工作之中，这是非常重要的。
- 例子1：行动控制领导者一定要避免事后诸葛亮，即作好“前馈”管理控制。
- 例子2：给予行动执行者过程中结果信息“反馈”，往往能够提升行动的控制效益

## 2 前馈控制原理

在行动实施过程中，一般首先需要以目标为指引，利用不断更新的环境信息，预见可能出现的情况变化，提前采取针对性的应对措施，将不利或风险化解在未萌或萌芽状态，将优势和成果巩固在将现或未现之际，即基于目标的预先控制。

基于目标的预先控制，需要围绕目标，预先设计行动，主导战局发展，其基本思想源于经典控制理论中的前馈控制。

前馈控制，是指通过观察情况、收集整理信息、掌握规律、预测趋势，正确预计未来可能出现的问题，提前采取措施，将可能发生的偏差消除在萌芽状态，为避免在未来不同发展阶段可能出现的问题而事先采取措施。

![ch14-前馈控制](./../images/img-2025-04-20/ch14-前馈控制.png)

- 前馈校正环节对作用于被控对象上的扰动信号进行间接或直接测量，生成前馈控制补偿量，经比较环节后输入控制器，进而提高系统控制的准确度。
- 前馈控制利用双通道原理进行扰动补偿，通过增加扰动信号的前向通道，在扰动还未影响输出之前直接改变输入具有快速性特点，使得被控变量不受或少受扰动的影响。
- 前馈控制属于开环控制。

## 3 反馈控制原理

态势是敌我双方力量、部署、行动和目标、环境，在统一时空基准下所形成的状态和发展趋势。

行动执行过程中，依托指挥信息系统，近实时地发现情况变化，开展临机调控行动力求先敌而动、快敌一步，即基于态势的实时控制。

基于态势的实时控制，近实时关注敌对双方的力量部署，运用所形成的对抗状态和形势，针对已经出现的偏差或异常情况及时作出响应，其基本思想源于经典控制理论中的反馈控制。

![ch14-反馈控制](./../images/img-2025-04-20/ch14-反馈控制.png)

反馈控制属于闭环控制

实施行动过程中的反馈控制需要注意以下3个方面：
...
自组织原理是关于在没有外部指令条件下，系统内部各子系统之间能自行按照某种规则形成一定的结构或功能的自组织现象的一种科学原理。

该原理主要研究系统怎样从混沌无序的初态向稳定有序的终态的演化过程和规律。

无序向有序演化必须具备几个基本条件：

1. 产生自组织的系统必须是一个开放系统，系统只有通过与外界进行物质、能量和信息的交换，才有产生和维持稳定有序结构的可能。

2. 系统从无序向有序发展，必须处于远离热平衡的状态，非平衡是有序之源。开放系统必然处于非平衡状态。

3. 系统内部各子系统间存在着非线性的相互作用。这种相互作用使得各子系统之间能够产生协同动作，从而可以使系统由杂乱无章变成井然有序。

## 2 自组织在作战中运用

定义：某个作战系统在作战过程中无需接受外界的特定指令。

强调根据态势自主做出全局性决策，各作战单元按照同一决策方案行动，从而表现出整体涌现性。

其决策依据不是上级指示(无指示或来不及指示)，而是当前态势、危险等级和作战规则等客观要素

其决策客体包括与本作战单元平等的多个单元或部队，规定他们之间的角色、任务以及行动顺序和协同配合问题。
