...
1915年，几乎与兰切斯特同时，奥西波夫在杂志《军事收藏》上发表了一系列瞩目的文章。它包含了一系列分析军事战斗损耗的理论，该理论在西方被称为“兰切斯特平方律”。奥西波夫的著作译本新近完成，这将使西方军事分析家更容易欣赏其优点。

**关键词**：历史；军事；时间；经验统计；微分方程；兰切斯特方程；奥西波夫

## 1 引言

Helmbold（1991）最近完成了奥西波夫（1915）五部分系列文章的英文翻译，该系列文章于1915年发表在俄国期刊《军事收藏》，题目为《敌对双方的数值兵力对其伤亡的影响》。这些文章刊登在《军事收藏》的以下几期：
...
Yusupov(1988)声称Osipov在发现通常被称为兰彻斯特方程的微分方程和被称为兰彻斯特n平方定律的关系方面具有优先权。我们希望下面的粗浅评论能对优先问题有所启发。

首先，我们注意到，在19世纪和20世纪初，对科学的战争理论的兴趣非常“在空中”。克劳塞维茨、约米尼、布洛赫、富勒、马汉等作家试图理解支配战争和作战力量相互作用的基本原理或科学规律。这种关注足够广泛，以至于在文学作品中得到了反映。例如，托尔斯泰(1865)写道:“军队的精神是一个因素，它乘以数量就会产生力量。定义和表达这种未知因素——军队精神——的意义，是科学的难题。十个人、营或师与十五个人、营或师作战，征服——也就是说，杀死或俘虏——所有其他人，而自己损失四个....因此，4人等于15人，因此4x = 15y。因此，x/y = 15/4。这个方程并没有给我们未知因子的值，而是给了我们两个未知数之间的比率。通过将各种选定的历史单位(战役、战役、战争时期)纳入这样的方程，可以得到一系列数字，其中应该存在某些规律，并且可能被发现。”此外，其他研究者也致力于编纂统计数据来支持这种探索(利弗莫尔、伯恩特、博达特等人)。Kipp(1987)提到了早期俄国人对军事统计和军事应用数学的兴趣，并在这方面特别注意到米柳亭和奥布鲁切夫(1871)的工作，他们分别是俄国的。亚历山大二世时期的战争部长，亚历山大二世、亚历山大三世和尼古拉斯二世时期的总参谋长，以及沃洛茨基(1903年)关于概率论和步兵和炮兵规范的著作。

但是为了关注更直接相关的工作，我们首先观察到菲斯克(1905)的获奖工作，正如Weiss(1962)所报道的那样，包含了兰彻斯特平方定律方程的离散版本的基本思想。Hugles (1988a)最近发现了Chase(1902)结果的奇怪故事，这些结果可能是该领域最早的，但直到1972年才解密。美国海军研究生学院的韦恩·休斯教授提请注意菲斯克(1916)的一个脚注，其中提到了这些结果，并指出这些结果是由海军少将耶胡·瓦伦丁·蔡斯使用“微积分的应用”获得的。蔡斯(1902)的一篇论文出现在休斯(1988b)的附录C中。

F.W.兰彻斯特(1916)的名著于1916年1月在伦敦出版。然而。早前的部分(特别是第五章和第六章)在1914年9月至12月间刊登在英国《工程学》杂志上。著名的“n平方”定律出现在兰彻斯特(1914)。兰彻斯特这本书的初稿是在1913年至1914年的冬天准备的。

相比之下，奥西波夫的文章发表于1915年6月至10月。在我们看来，作品本身的结构、形式和惊人的独创性证明了他长时间的沉思。此外，根据内部证据，我们认为奥西波夫对兰彻斯特或菲斯克的工作都没有直接或具体的了解，他的成就是独立于他们的。为了支持这一观点，让我们指出，奥西波夫在他的序言的最后一句话中明确要求优先(以及，不太明确，在他的系列文章的其他地方)，并且没有提及先前的工作以及他整个演讲的主旨，使这一观点更加可信。

## 3 奥西波夫与兰彻斯特著作比较

即使事实证明奥西波夫知道菲斯克或兰彻斯特的工作(例如，通过兰彻斯特在《工程》杂志上发表的文章)，奥西波夫的独特贡献也可以说比兰彻斯特的贡献更加实质性和重要。奥西波夫对这个问题的研究更深入，他的方法和观点更健全、更科学，这使他站在了那些对战斗理论感兴趣的人的前列。

一般来说，兰彻斯特的演讲比奥西波夫的更具视觉性和说教性。两者都注重力量的质量和集中。奥西波夫的书中充斥着更多的东西。表格和公式，而兰彻斯特强调图形显示。奥西波夫实际上写下了平方定律损耗方程的一般数学解。虽然我确信兰彻斯特知道这个答案，但他并没有在他的著作中提出，而是满足于用图形的例子。总的印象是，奥西波夫采取了科学的方法，而兰彻斯特采取了政治的、辩论的或倡导的方法。
...
在他的第一段中，奥西波夫提出了一个基本的挑战:“在战斗中取得胜利的所有主要原因或环境是什么?”无疑，这是所有军事行动分析中最根本的问题。面对这一挑战，奥西波夫提出了一个假设，即损失与优势成反比。这个定性假设可以翻译成现代数学符号，大致为
...
在那之后。奥西波夫给出了一些接触力相互损耗的数值例子来介绍他对平方定律损耗方程的数学发展。为了给奥西波夫的论文增添趣味，我们举例说明了奥西波夫对他的公式的推导。令$A$和$B$表示战斗人员队伍中步枪的初始数值强度，$A$表示一名步枪在所有单位时间内造成的命中，$t$表示到期时必须找到交战双方步枪的剩余强度$A'$和$B'$。奥西波夫的目的是证明这些与初始强度有一个非常简单的关系，即
...
$$
n \Delta \left\{\begin{matrix}
 A'_n = A - n(\alpha \Delta t)B + \frac{n(n-1)}{1 \cdot 2}(\alpha \Delta t)^2 A - \frac{n(n-1)(n-2)}{1 \cdot 2 \cdot 3}(\alpha \Delta t)^3 B \\
 B'_n = B - n(\alpha \Delta t)A + \frac{n(n-1)}{1 \cdot 2}(\alpha \Delta t)^2 B - \frac{n(n-1)(n-2)}{1 \cdot 2 \cdot 3}(\alpha \Delta t)^3 A
\end{matrix}\right.
$$
...
通过这些公式，奥西波夫表明，在 $m$ 大于 $1$ 的情况下，即侧翼被翻转时，与 $A + C$ 步枪兵与 $B$ 步枪兵正面攻击的战斗相比，在 $m$ 等于 $1$ 的情况下，幸存者 $A’$ 和 $B’$ 的数量会增加，$B’$ 的数量会减少。

最后，奥西波夫假设两个战斗人员有：1）$A$ 名步枪手命中 $\alpha$，$M$ 门大炮命中 $\gamma$，$P$ 挺机枪命中 $\varepsilon$（单位时间），2）$B$ 名步枪手命中 $\beta$，$N$ 门大炮命中 $\alpha$，$Q$ 挺机枪命中 $\zeta$。然后，对于 $t$ 单位时间进入战斗后剩下的数字 $A'$ 和 $B'$，奥西波夫找到了以下公式，为
$$
...
> “所有的推导公式都是明确假设的必然结果。其中包括一个假设，即在无限短的时间内，双方的伤亡将与他们的数值强度成反比，即 $\text{d} A \times A =\text{d}B \times b$。如果我们要将伤亡理论建立在无限短的时间内伤亡与数值强度的平方根成反比的假设上，即 $\text{d} A \sqrt{A} = \text{d} B \sqrt{B}$，那么代替公式(1)，我们将取而代之，有
> $$
...
奥西波夫认为，如果战斗力的 $N$ 次方定律是正确的，那么 $A$ 方的损失可以写成
$$
a = A - \sqrt{A^2-B^2+B'^2}.
$$
因此，计算出来 $v_i=a_{\text{computed}}-a_{\text{observed}}$，即根据该公式计算出的 $A$ 方的损失与历史记录的损失之间的差异，衡量了该理论与第一次战斗的历史记录的偏离程度。奥西波夫通过检查 $v$ 的平均值和标准差来检验该理论与历史的吻合程度。如果它们的平均值相对于它们的标准偏差离零太远，那么这表明一些“系统趋势”导致了这种偏离理论。奥西波夫用这种方式检验了一些理论。其中一种理论使用了方程
$$
A^n-A'^n=B^n-B'^n,
$$
...
而另一种理论用指数 $3/2$ 代替 $2$ 。作为这些假设检验的结果，奥西波夫发现了一个重要的事实，即取值为 $n=3/2$ 时，“无比地符合现实”。即战斗力与战斗人员数量的平方成不成正比。我称之为“奥西波夫定律”。
...
奥西波夫通过10个数值例子说明了他的方程的应用。其中第一个是在特定条件下对双方损失数量的直接估计，并表明当a方对B方施加更大的力时，情况会更好。下一个问题是B方的断点为20%，我们想要找到a方的损失。第三个问题是一方只有效地利用了其力量的一部分。问题4是根据普列夫纳战役的历史数据估算损耗系数。第5题将这个损耗系数的比值作为已知值，并问在普列夫纳战役中需要多少俄国人才能达到收支平衡上的损失。问题6解决的是在A方可能投入2500人或3000人，B方可能投入2000人或2500人的情况下，四种备选方案中哪一种是最合适的。问题7比较了B方分批或一次性全部投入战斗的结果。问题8分析了一场战役的结果，在这场战役中，a方使用其大部队连续三次与规模较小的B方分队交战，假设a方部队在三次交战中每一次都遭受一定的消耗，并使用其幸存的部队进行下一次交战。问题9处理的是兵力的最优分配问题。第10题说明，当双方数值相等时，总损失要比双方数值不相等时高得多。

奥西波夫将他的结论总结为三个主要论点，即：

1. 人数最多的一方承受绝对较小的损失，而不是人数较弱的一方。
...
在这里，我将尝试总结一下我认为奥西波夫作品的主要优点和缺点。首先，我们首次在已发表的著作中找到兰彻斯特耦合微分方程解的显式公式。奥西波夫用一种独特的方法得到了这个解，据我们所知，这种方法之前或之后都没有在其他地方出现过。此外，我们还找到了一种独特的由该解推导兰彻斯特平方定律的方法，以及首先从兰彻斯特微分方程中消去时间参数的常用推导方法。奥西波夫还明确地将微分方程与差分方程联系起来，并证明差分方程的解在时间步长趋于零时接近前者的解。这一结果后来被Engel(1963)独立地重新发现。

奥西波夫对非均匀力的处理是当时的另一个独特之处。奥西波夫从解决由单一类型单位(即仅装备步枪的步兵)组成的部队的幸存者开始，陆续引入了其他类型的武器，特别是火炮和机枪。当他们被介绍时，奥西波夫定义了将炮兵和机枪与步兵当量相关的“转换因子”，并根据历史信息估计，一门大炮相当于大约100名步兵。他在这里的方法在概念上与许多当代(西方和苏联)聚合力模型中使用的方法相同——参见Taylor(1983)和Yusupov(1988)——重要的例外是，奥西波夫努力从历史数据中获得他的转换因子的数值估计。
...
也许奥西波夫先生是他的亲戚，我们不知道）。Kipp（1987）还指出，虽然戈洛文（1938）有很长的一节是关于奥托·本特的，但他没有提到奥西波夫。Kipp博士告诉我们，他花了很长时间、很辛苦地寻找关于这些杰出文章的作者奥西波夫的更多信息，但没有成功。
