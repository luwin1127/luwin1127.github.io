...
**注意**：下面的字体设置因学校而已，我这里仅仅拿我们学校的规范作为例子。
...
（1）“<font face="Times New Roman">**Abstract**</font>”为 Times New Roman，三号，加粗，居中显示。
...
在图6所示页面中，先选“自定义”，然后选择文物线（注意别选错了，是上面粗下面细的文武线），接着只选择编号3处选项，最后应用于段落，点击确定。
